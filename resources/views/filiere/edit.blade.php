...
<div class="container-fluid mt-4 ">
    <div id="collapseExample" class="col-md-5 mx-auto mt-4 bg-light shadow-sm p-4 ">
        <form action="{{route('filiere.update',$filiere)}}" class="" method="post" enctype="multipart/form-data">  
           @method('PUT')
            @csrf
            ...
            <div class="d-flex justify-content-center">
                <button type="submit" class="btn btn-outline-primary shadow-sm ">Modifier</button>
            </div>
        </form>
    </div>
</div>
